...
if (isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['password']) && isset($_POST['email']) && isset($_POST['phoneNumber']) && isset($_POST['username'])) {
    ...
    if ($conn) {
        ...
        VALUES ('$firstName', '$lastName', '$password', '$email', '$phoneNumber', '$username', '4');";
            $result = mysqli_query($conn, $sql);
        }
                ...
                <div class="col">
                    <div>
                        <form action="" class="text-align-input" method="POST">
                            <div class="shadow-sm" style="margin:auto;width:400px; background-color:white; height:550px; margin-bottom:50px;margin-top:50px">
                                <a href="index.php" style="display:none; font-family: Pacifico, cursive;font-size: 45px;margin-top:0px; color:#222222" onclick="goToHome()">DigiMall</a>
                                ...
                                <div><label class="text-center d-block form_text_center">Password:*</label>
                                    <input id="pass" name="password" class="border rounded-0 shadow-sm" type="password" required="" onblur="validate()">
                                </div>
                                ...
                                <button class="btn btn-primary border rounded border-dark" type="Submit" style="background-color: rgba(255,249,219,0.5);color: #222222;opacity: 1; margin-top : 20px" onclick=""><em>Add Staff</em></button>
