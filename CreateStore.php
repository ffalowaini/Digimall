...
<?php
    ...
    <div class="contact-clean"
        style="width: 90%;margin: auto;background-color: rgba(255,249,219,0.7);margin-top: 80px;">
        ...
        <form method="post">
            ...
            <!--Submit DIV group-->
            <div class="form-group">
                <input id="submitBtn" class="btn border rounded border-dark shadow" data-bs-hover-animate="pulse"
                    type="submit" style="background-color: rgba(252,239,176,0.5);" value="Create" onclick="onSubmit()">
            </div>
                ...
                $.ajax({
                    ...
                    success: function (session) {
                        ...
                        $.ajax({
                            ...
                            url: "https://digimall.today/php/insertCreateStore.php",
                            method: "POST",
                            data: form_data,
                            processData: false,
                            contentType: false,
