    ...
    <form action="SearchResult.php" method="post">
        <nav class="navbar navbar-light navbar-expand-md fixed-top shadow-sm navigation-clean-search">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.html" style="width: 136px;height: 40px;font-family: Pacifico, cursive;font-size: 30px;margin-bottom: 8px;" onclick="goToHome()">DigiMall</a>
