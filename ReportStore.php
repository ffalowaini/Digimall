...
if (isset($_SESSION['UserID']) && isset($_SESSION['ToStoreID'])) {
    $userID = $_SESSION['UserID'];
    $toStoreID = $_SESSION['ToStoreID'];
}else{
...
if (isset($_POST['message'])) {
    ...
    $query = "INSERT into report (FromUserID,message,type,ToStoreID, ReportStatus, ReportSendType, Assigned) values ('$userID','$msg','1','$toStoreID', '1', '1', '0')";
