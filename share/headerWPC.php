        ...
        <nav class="navbar navbar-light navbar-expand-md fixed-top shadow-sm navigation-clean-search">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <div class="" data-bs-hover-animate="pulse" style="width: 100px;height: 35px;" onclick="goToWishlist(<?php echo $userID ?>)">
                    ...
                    <div class=" margins" data-bs-hover-animate="pulse" id="cart" style="width: 100px;height: 35px;" onclick="goToCart()" href="">
